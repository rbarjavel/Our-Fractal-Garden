...
export class Migration20210317180920 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "tree" ("id" serial primary key, "guid" text not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "name" varchar(255) not null, "branchs" text not null, "colors" text not null, "songs" text not null);');
  }
